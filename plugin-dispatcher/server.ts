...
const mcp = new Server(
  { name: 'lark', version: '1.0.0' },
  {
    ...
    instructions: [
      ...
      '',
      'reply sends a Markdown card by default. For rich/structured replies (tables, charts, multi-section layouts, status dashboards), prefer using the /feishu-card skill to generate proper Lark card JSON, then pass the JSON as the text parameter of the reply tool — it will be auto-detected and sent as an interactive card.',
      '',
      'Use react to add emoji reactions (Lark emoji types like "OK", "ThumbsUp", "HEART"). Use fetch_messages to pull recent history.',
      '',
